...
df_raw = pd.read_sql_table('finam_daily_close', 'postgres://ml_user:ml_user@localhost:5432/ML', schema='original', index_col='date')
...
df_merged.plot(y=['sber_n', 'sber_r'], subplots=True, kind='line')
plt.show()
